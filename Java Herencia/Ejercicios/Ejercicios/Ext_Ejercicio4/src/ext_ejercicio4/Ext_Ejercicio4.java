...
public class Ext_Ejercicio4 {
    ...
    public static void main(String[] args) {
        ...
        SistemaGestionFacultad estudiante = new Estudiante("matematicas", "erik", "narvaez", 123456, "soltero");
        SistemaGestionFacultad profesor = new Profesor("literatura", "kleyden", "baez", 1234, "casado", 1990, 1);
        SistemaGestionFacultad pServicio = new PersonalServicio("biblioteca", "reyna", "reynosa", 12345, "soltera", 2000, 2);
